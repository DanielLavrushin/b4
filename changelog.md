...
- FIXED: **After a configuration file was cut short, for example by a power loss during a save, b4 started on the defaults and wrote them over the file at the next save** - the file was rewritten in place, so an interrupted save left it truncated, and b4 carried on after failing to read it.
