...
Корень зеркала, `/`, - страница для браузера: какой хаб оно зеркалирует, какой каталог хранит с номером сборки, датой сборки и сроком действия, когда вышестоящий хаб проверялся в последний раз и ответил ли он, и чем закончилось последнее объявление. Язык страницы - английский или русский по языку браузера. Тексты ошибок, запись объявления и ключ подписи на неё не попадают; они есть в журнале зеркала.
