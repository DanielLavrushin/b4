...
| `--tables-monitor-interval` | Как часто проверять и восстанавливать правила, в секундах. С NFQUEUE `0` отключает проверку; в режиме TUN интервал не меньше 10, и `0` её не отключает | `10` |
