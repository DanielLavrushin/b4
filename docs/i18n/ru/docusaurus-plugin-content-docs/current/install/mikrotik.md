...
В веб-интерфейсе (`http://192.168.210.10:7000`) включается **NAT Masquerade** в разделе [Настройки -> Основные -> Фаервол](../settings/core#фаервол). Интерфейс маскарада остаётся по умолчанию - все интерфейсы.
