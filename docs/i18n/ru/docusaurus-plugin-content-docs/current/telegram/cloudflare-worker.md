...
Он стоит последним среди маршрутов WebSocket, после собственного узла Telegram и после общего пула CF, и вступает в гонку через полторы секунды после начала подключения, если ни один из них к этому времени не подключился.
