...
:::info
Самовосстановлению нужен дискавери, а дискавери нужен движок захвата NFQUEUE. На движке TUN мониторинг продолжает проверять домены и сообщать о неотвечающих, но помечает их как невосстановимые, а не чинит. См. [Движок захвата](./settings/engine#дискавери-недоступен).
:::
