...
Это не то же самое, что вкладка **Импорт/Экспорт** в редакторе сета, которая переносит готовый сет b4 между установками b4 в виде JSON, и не то же самое, что [общий сет](./sharing.md) - форма для передачи сета другому человеку.
