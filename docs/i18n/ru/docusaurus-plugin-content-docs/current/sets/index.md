...
- **Импорт/Экспорт** - JSON-представление конфигурации сета для переноса между устройствами. Чтобы перенести конфигурацию из byedpi или zapret, см. [Импорт из другого инструмента](./import)
...
Исходные устройства (MAC-адреса) и настройки [Эскалации](./escalation) не экспортируются - они ссылаются на локальное состояние (устройства и другие наборы), которое не переносится между устройствами. Настройте их заново на целевом устройстве.
