...
Сет - это набор настроек обхода DPI, привязанный к списку доменов, IP-адресов, ASN, UDP-портов или категорий GeoSite/GeoIP. Можно создать несколько сетов с разными стратегиями для разных сайтов.
...
- **Импорт** - собрать сеты из командной строки byedpi или zapret, см. [Импорт из другого инструмента](./import)
...
Редактор содержит 7 вкладок:

- [Цели](./targets) - домены, IP, GeoSite/GeoIP категории, ASN, устройства
...
- [Дискавери](./discovery) - адреса, которые Дискавери проверяет для сета, последний поиск для него и переключатель мониторинга
- **Импорт/Экспорт** - JSON-представление конфигурации сета для переноса между устройствами и [общий сет](./sharing) для передачи сета другому человеку. Чтобы перенести конфигурацию из byedpi или zapret, см. [Импорт из другого инструмента](./import)
...
Сет, предназначенный другому человеку, готовится как [общий сет](./sharing): из него исключается всё, что привязано к этому роутеру. Исходные устройства (MAC-адреса) и настройки [Эскалации](./escalation) не экспортируются - они ссылаются на локальное состояние (устройства и другие наборы), которое не переносится между устройствами. Настройте их заново на целевом устройстве. JSON переносит [адреса Дискавери](./discovery) сета, но не переключатель мониторинга, поэтому импортированный сет начинает без мониторинга.
