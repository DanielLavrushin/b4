...
- **Трафик** - пакеты, которые разбирает b4, в реальном времени
...
- **[Telegram](./telegram/index.md)** - MTProto-прокси, прозрачный WebSocket-мост для всех устройств за b4 и WEB-прокси для Telegram Desktop
