...
- откат включил бы мониторинг сета или общий мониторинг либо вернул бы адреса Дискавери или домены мониторинга, пока **Разрешить активные проверки** выключено: мониторинг начал бы запрашивать эти сайты по расписанию.
