...
Здесь собрано то, что действует на DNS во всех сетах: перехватывается ли DNS поверх TCP, на какой порт он заворачивается, и таймауты. Сам резолвер выбирается в сете. См. [DNS](../dns.md).
