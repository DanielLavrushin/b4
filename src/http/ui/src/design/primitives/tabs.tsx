...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        "group/tabs flex min-h-0 flex-1 gap-2 data-[orientation=horizontal]:flex-col",
        className,
      )}
      {...props}
    />
...
const tabsListVariants = cva(
  "rounded-lg p-[3px] gap-2 group-data-horizontal/tabs:h-fit data-[variant=line]:rounded-none group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        default: "bg-muted",
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "min-h-0 flex-1 overflow-y-auto text-xs/relaxed outline-none",
        className,
      )}
      {...props}
    />
